...
def staging():
    ...
    env.project_root = '<project_root>/test_patch'
    env.GIT_REPO = 'git@github.com:<git_user>/test_patch.git'
    env.APPS = [] # put your apps here that should tests run before deploy
    env.SETTINGS_LOCAL = 'test_patch.settings_local' 
